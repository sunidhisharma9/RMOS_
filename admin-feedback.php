<?php
    ...
    $sql1 = "SELECT * FROM feedback order by feedback_id asc limit $start, $num_per_page";
...
<section class="feedback">
  <h5 class="section-heading">FEEDBACK</h5>
</section>
    ...
    <div class="card">
      <div class="card-body p=0">
        <table class="table table-striped">
          <thead class="bg-dark">
              <tr class="border-0">
                  <th class="border-0">Feedback Id</th>
                  <th class="border-0">Customer Name</th>
                  <th class="border-0">Service</th>
                  <th class="border-0">Quality of Food</th>
                  <th class="border-0">Cleanliness</th>
                  <th class="border-0">Value for Money</th>
          ...
          while($row = mysqli_fetch_assoc($res1))
             {
               ...
               echo "<td>"; echo $row["clean"] ; echo "</td>";
                  ...
                  <div class="page col-md-10">
                      <ul class="pagination table">
                        ...
                        <li class='page-item <?php ($page <= 1 ? print 'disabled' : '')?>'>
                          <a class='page-link' href='admin-feedback.php?page=<?php ($page>1 ? print($page-1) : print 1)?>'>Previous</a>
                        </li>
                        <!-- Links of the pages with page number -->
                        <?php for($i=1; $i<=$total_pages; $i++) { ?>
                        <li class='page-item <?php ($i == $page ? print 'active' : '')?>'>
                          <a class='page-link' href='admin-feedback.php?page=<?php echo $i;?>'><?php echo $i;?></a>
                        </li>
                        <?php } ?>
                        <!-- Link of the next page -->
                        <li class='page-item <?php ($page >= $total_pages ? print 'disabled' : '')?>'>
                          <a class='page-link' href='admin-feedback.php?page=<?php ($page < $total_pages ? print($page+1) : print $total_pages)?>'>Next</a>
                        </li>
                      </ul>
